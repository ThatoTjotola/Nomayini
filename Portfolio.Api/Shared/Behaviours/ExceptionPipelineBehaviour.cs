...
using MediatR;
using Portfolio.Api.Shared.Exceptions;

namespace Portfolio.Api.Shared.Behaviours;
    public sealed class ExceptionPipelineBehavior<TRequest, TResponse>(ILogger<ExceptionPipelineBehavior<TRequest, TResponse>> logger) : IPipelineBehavior<TRequest, TResponse>
