...
public class KafkaConsumerService : IKafkaConsumerService
{
    ...
    private readonly bool? _notificationToggle;
    ...
    public KafkaConsumerService(IEmailService emailService, IConfiguration configuration, IOptions<NotifyerSettings> notifyerSettings)
    {
        ...
        var notificationToggle = configuration["NotifyerSettings:EnableEmailSendTrue"];
        ...
        _notificationToggle = !string.IsNullOrEmpty(notificationToggle) ? bool.Parse(notificationToggle) : (bool?)null;
    }
    ...
    public async Task ConsumeMessages(string topic)
    {
        ...
        try
        {
            while (true)
            {
                ...
                if (_notificationToggle ?? _notifyerSettings.EnableEmailSend)
                {
