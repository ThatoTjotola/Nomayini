...
{
    public sealed class PostMessageCommandHandler(IAppDbContext db, IHttpContextAccessor context, ILogger<PostMessageCommandHandler> logger): IRequestHandler<PostMessageCommand, string>
    {
        public async Task<string> Handle(PostMessageCommand command,CancellationToken cancellationToken)
        {
