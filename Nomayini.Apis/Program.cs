    ...
    options.AddDocumentTransformer((document, context, _) =>
    {
        document.Info = new()
        {
            ...
            Description = """
                ...
                Hosting my own projects and managing resources efficently,if you wanna see go to read me note still WIP : wanna take a peak : https://github.com/ThatoTjotola/Nomayini , this fundamently a challenge for myself , how efficient can i write my code 
